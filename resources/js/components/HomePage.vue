    ...
    <div class="home-page">
        ...
        <section class="categories-section py-5">
            <div class="container">
                ...
                <div class="row">
                    <div v-for="category in categories" :key="category.id" class="col-6 col-md-3 col-lg-2 mb-4">
                        <router-link 
    ...
    setup() {
        ...
        const fetchHomeData = async () => {
            try {
                ...
                categories.value = [
                    { id: 1, name: 'Electrónica', slug: 'electronica', icon: 'bi bi-phone' },
                    { id: 2, name: 'Moda', slug: 'moda', icon: 'bi bi-bag' },
                    { id: 3, name: 'Casa', slug: 'casa', icon: 'bi bi-house' },
                    { id: 4, name: 'Desporto', slug: 'desporto', icon: 'bi bi-bicycle' },
                    { id: 5, name: 'Beleza', slug: 'beleza', icon: 'bi bi-droplet' },
                    { id: 6, name: 'Livros', slug: 'livros', icon: 'bi bi-book' },
                ];
                ...
                featuredProducts.value = [
                    {
                        ...
                        store_name: 'TechStore Angola',
                        store_slug: 'techstore-angola',
                        stock_status: 'in_stock',
                        stock_quantity: 15
                    },
                    {
                        id: 2,
                        name: 'T-shirt Casual Algodão',
                        price: 2500,
                        current_price: 2500,
                        rating: 4.2,
                        review_count: 12,
                        sales_count: 78,
                        image: '/images/placeholder-product.png',
                        store_name: 'Moda Africana',
                        store_slug: 'moda-africana',
                    ...
                    },
                    {
                        ...
                        sales_count: 12,
                        image: '/images/placeholder-product.png',
                        store_name: 'Casa & Cozinha',
                        store_slug: 'casa-cozinha',
                        stock_status: 'in_stock',
                        stock_quantity: 25
                    },
                    {
                        ...
                        sales_count: 34,
                        image: '/images/placeholder-product.png',
                        store_name: 'Desporto Total',
                        store_slug: 'desporto-total',
